...
public class MyAdapters extends RecyclerView.Adapter<MyAdapters.MyHolder> {
    private ArrayList<String> mList;
    private Context context;
//    RequestOptions options;

    public MyAdapters(ArrayList<String> mList, Context context) {
        this.mList = mList;
...
//        MyAdapter myAdapter = new MyAdapter(arrayList,context);
